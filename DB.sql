...
Insert into Basi (nome) values ("basi/11 - Goodbye - Big Joe.mp4");
Insert into Basi (nome) values ("basi/Big L  Ebonics.mp3");
Insert into Basi (nome) values ("basi/Busta Rhymes - Psycobusta.mp3");
Insert into Basi (nome) values ("basi/Dilated Peoples - The Platform (Erik Sermon Remix).mp3");
Insert into Basi (nome) values ("basi/DJ Premier - BAP.mp3");
Insert into Basi (nome) values ("basi/DJ Premier - That White.mp3");
Insert into Basi (nome) values ("basi/Full Clip-Gangstarr.mp3");
Insert into Basi (nome) values ("basi/Funkdoobiest - Lost in Thought.mp4");
Insert into Basi (nome) values ("basi/Gang Starr - Battle.mp3");
Insert into Basi (nome) values ("basi/J. Cole - Fire Squad.wav");
Insert into Basi (nome) values ("basi/Jam Baxter - Fine (Prod GhostTown).mp4");
Insert into Basi (nome) values ("basi/Method Man _ Redman - A-Yo.mp4");
Insert into Basi (nome) values ("basi/Movie Villains.mp4");
Insert into Basi (nome) values ("basi/Noyz Narcos - Trucemala.mp3");
Insert into Basi (nome) values ("basi/RA Rugged man - Dangerous Three.mp3");
Insert into Basi (nome) values ("basi/Step Brothers (Alchemist _ Evidence) - Step Masters.mp4");
Insert into Basi (nome) values ("basi/Tecniche Perfette - 5.mp4");
Insert into Basi (nome) values ("basi/Wu Tang Clan _ Mobb Deep - Phat Beat.mp3");
Insert into Basi (nome) values ("basi/Timbaland - They Ain_t Ready.mp3");